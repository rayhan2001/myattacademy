...
{{--                </li> <!-- end Dashboard Menu -->--}}
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{route('grade.index')}}">
                        <i class="ri-honour-line"></i> <span data-key="t-widgets">Grade</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{route('language.index')}}">
                        <i class="ri-honour-line"></i> <span data-key="t-widgets">Language</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{route('difficulties.index')}}">
                        <i class="ri-honour-line"></i> <span data-key="t-widgets">Difficulties</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{route('course.index')}}">
                        <i class="ri-honour-line"></i> <span data-key="t-widgets">Course</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{route('resource.index')}}">
                        <i class="ri-honour-line"></i> <span data-key="t-widgets">Resource</span>
                    </a>
                </li>
{{--                <li class="nav-item">--}}
...
{{--                </li>--}}
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarPages" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarPages">
                        <i class="fa-solid fa-gear"></i> <span data-key="t-pages">Settings</span>
                    </a>
